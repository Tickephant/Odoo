    ...
    barcode_product_action: function(code){
        ...
        if (self.pos.scan_product(code)) {
            ...
            if(code['code'].substring(0,4)=="9308"){
				tickephant_code=code['code'];
				console.log(tickephant_code);
				self.gui.show_screen(self.barcode_product_screen, null, null, true);
				self.gui.show_popup('confirm',{
                        'title': 'Usuario tickephant aceptado',
                        'body': 'Se ha añadido el usuario tickephant al carro, no se imprimira el ticket',
                    });
